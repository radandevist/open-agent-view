...
For deliberately unattended work, `oav --yolo` pre-arms one launch for a
verified native permission-bypass mode on supported harnesses, stays visibly
marked in the composer/native session, and fails closed everywhere else. It is
